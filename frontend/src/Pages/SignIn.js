...
const SignIn = ({location,history}) => {
    ...
    const redirect = location.search ? location.search.split('=')[1] : '/FirstPage'
    useEffect(() => {
        if (userInfo) {
                    ...
                    <MDBRow>
                            ...
                            <MDBAnimation type='fadeInLeft' delay='.3s'>
                                <MDBCard id='classic-card'>
                                    <MDBCardHeader className='white-text font-weight-bold '>
                                        <h2 className='h2-responsive font-weight-bold text-center'>ESPACE PHARMACIEN</h2>
                                    ...
                                    <MDBCardBody className='white-text'>
                                        ...
                                        <Form onSubmit={submitHandler}>
                                            ...
                                            <div className='text-center mt-4 black-text'>
                                                ...
                                                <hr className='hr-light' />
                                                <h5 className="white-text">Vous n'êtes pas encore inscrits ? <Link to={redirect ?`/Signup?redirect=${redirect}`
                                                :'/Signup'} id='signuplink'>Inscrivez vous ! </Link></h5>
                        ...
                        >
                            <h1 className='h1-responsive font-weight-bold'>
                                Vous n'êtes pas encore inscrit ?                  </h1>
                            <hr className='hr-light' />
                            <h5 className='mb-4'>
                                ...
                                <br />
                                    - Effectuez vos commandes en ligne
                                      <br />
                                    - Obtenez vos duplicatas de facture en un clic  <br />
                                    - Consultez les tarifs et les conditions générales de vente  <br />
                            </h5>
