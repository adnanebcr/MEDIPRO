  ...
  >
    <MDBRow>
              ...
              <Form onSubmit={this.formSubmit}>
                ...
                <div className="text-center mt-4 black-text">
                  ...
                  <MDBModal isOpen={this.state.modal} toggle={this.toggle}>
                    ...
                    <MDBModalFooter>
                      {this.renderRedirect()}
                      <MDBBtn color="secondary" onClick={this.setRedirect}>
                        Close
                      </MDBBtn>
                    </MDBModalFooter>
                  </MDBModal>
      ...
      >
        ...
        <Alert variant="success">
          <ul>
            ...
            <li>
              <p>
                Après vérification, MEDIPRO PHARMA vous remettra votre jeu de
                connexion : code client et mot de passe.
              </p>
            </li>
            <li>
              <p>
                MEDIPRO PHARMA s'engage à respecter la confidentialité des
                informations personnelles renseignées et en particulier à ne pas
                divulguer votre adresse électronique.
              </p>
            </li>
          </ul>
        </Alert>
      ...
      <MDBAnimation
        type="fadeInRight"
        delay=".3s"
        className="black-text text-center text-md-left "
      ></MDBAnimation>
    </MDBRow>
  </MDBContainer>
</MDBView>; */
